...
public class CountItemsInThePage {
	...
	public void dressClick() throws InterruptedException {
		...
		Thread.sleep(10000);
		String items=driver.findElement(By.xpath("//div[@class='top-pagination-content clearfix']//div[@class='product-count'][contains(text(),'Showing 1 - 5 of 5 items')]")).getText();
