...
public class AddToCart {
	...
	public void addToCart() throws InterruptedException {
		...
		WebElement img=driver.findElement(By.xpath("//ul[@id='homefeatured']//li[@class='ajax_block_product col-xs-12 col-sm-4 col-md-3 first-in-line first-item-of-tablet-line first-item-of-mobile-line']//img[@class='replace-2x img-responsive']"));
		Actions action=new Actions(driver);
		action.moveToElement(img).build().perform();;
		action.moveToElement(driver.findElement(By.xpath("//*[@id=\"homefeatured\"]/li[1]/div/div[2]/div[2]/a[1]/span"))).click().build().perform();
		Thread.sleep(10000);
		action.moveToElement(driver.findElement(By.xpath("//div[@class='layer_cart_cart col-xs-12 col-md-6']")));
		action.moveToElement(driver.findElement(By.xpath("//span[contains(text(),'Proceed to checkout')]"))).click().build().perform();
