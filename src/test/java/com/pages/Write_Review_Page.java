...
public class Write_Review_Page {
	...
	public void clickOnMoreBtn() throws InterruptedException {
		 driver.findElement(By.xpath("//li[@class='ajax_block_product first-in-line first-item-of-tablet-line first-item-of-mobile-line col-xs-12']//span[contains(text(),'More')]")).click();
		 Thread.sleep(2000);
	}
